...
int main() {
    ...
    // Test case: Copy constructor (deep copy check)
    {
        ...
        std::cout << "arrCopy size: " << arrCopy.size() << std::endl;

        std::cout << "arr after copy:" << std::endl;
    ...
    // Test case: Assignment operator (deep copy check)
    {
        ...
        std::cout << "arrAssigned before copy:" << std::endl;
        try {
        ...
        std::cout << "arrAssigned size: " << arrAssigned.size() << std::endl;

        arrAssigned = arr;

        std::cout << "arrAssigned after copy:" << std::endl;
        std::cout << "arrAssigned[0] = " << arrAssigned[0] << std::endl;
        std::cout << "arrAssigned[1] = " << arrAssigned[1] << std::endl;
        std::cout << "arrAssigned[2] = " << arrAssigned[2] << std::endl;
        std::cout << "arrAssigned size: " << arrAssigned.size() << std::endl;
